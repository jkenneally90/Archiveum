...
> **⚠️ Voice Models Required:** Before running the installer, you must manually download the Piper voice models and place them in the `piper-voices/` folder. These are large files (~50-100MB each) and not included in the repository.
>
> 1. Download voices from [Piper Voices](https://github.com/rhasspy/piper/releases/tag/v1.2.0) or [Hugging Face](https://huggingface.co/rhasspy/piper-voices/tree/main)
> 2. Extract to `C:\Users\<username>\Documents\Archiveum\piper-voices\` (or your clone directory)
> 3. The folder structure should look like: `piper-voices/en/en_GB/jenny_dioco/medium/en_GB-jenny_dioco-medium.onnx`
>
> **Note:** Without voice models, Piper TTS will fail with a timeout error during the voice test.
